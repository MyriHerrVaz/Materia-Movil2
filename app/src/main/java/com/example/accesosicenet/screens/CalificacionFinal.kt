...
class CalificacionFinal : ComponentActivity() {
...
fun CalificacionFinal(
    ...
    Scaffold(
        ...
        CalificacionFinalContent(navController, viewmodel)
    }
}
@Composable
fun CalificacionFinalContent(navController: NavController, viewmodel: LoginView){
